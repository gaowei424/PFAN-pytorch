...
class SODLoader(Dataset):
    ...
    def __init__(self, mode='train', augment_data=False, target_size=256):
        if mode == 'train':
            self.inp_path = '/home/gaowei/dataset/iSAID_DOTA1.0_split/train/images'
            self.out_path = '/home/gaowei/dataset/iSAID_DOTA1.0_split/train/binary_masks'
        elif mode == 'test':
            self.inp_path = '/home/gaowei/dataset/iSAID_DOTA1.0_split/val/images'
            self.out_path = '/home/gaowei/dataset/iSAID_DOTA1.0_split/val/binary_masks'
        else:

...
def parse_arguments():
    ...
    parser.add_argument('--img_size', default=512, help='Image size to be used for training', type=int)
...
class Engine:
    def __init__(self, args):
        ...
        self.model_path = args.base_save_path + '/isaid_alph-{}_wbce_w0-{}_w1-{}'.format(str(self.alpha_sal), str(self.wbce_w0), str(self.wbce_w1))
